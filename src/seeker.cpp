...
void seeker::SetSeekerSpeeds(dude *target)
{
	switch (target->breed)
	{
		case YELLOW_SEEKER:
...
void  seeker::EliminateSeeker (dude *target)		
{
	dude  *traversal_ptr;
	int32 i;
...
void seeker::SendHome(dude *target)
{
	CCB	*temp_ccb;
	int32 i,j;
...
int32 seeker::DetermineDirection (dude *target, int32 old_x, int32 old_y)
{
	int32	new_direction;
...
void seeker::ChangeDirection (dude *target, int32 new_direction)
{
...
bool seeker::Obstructed(dude *target, bool ignore_rocks)
{
...
bool seeker::StupidMovement(dude *target)
{
	int32	old_x,old_y;
...
void seeker::PlanObstacleDetour (dude *target, int32 x, int32 y)
{
...
bool seeker::AvoidObstruction(dude *target, int32 old_x,int32 old_y,
...
bool seeker::RiskyMovement(dude *target)
{
	int32	old_x,old_y;
...
bool seeker::RunAway (dude *target)
{
	CCB   *dude_ccb;
	int32	old_x,old_y;
	bool  hazards_ahoy;
...
int32 seeker::PlanHazardDetour (dude *target, int32 dude_x, int32 dude_y)
{
...
bool seeker::AtGoalEdge (dude *target,int32 axis,int32 direction,int32 old_x,
                         int32 old_y)
{
...
bool seeker::ChasingWildGeese (dude *target)
{		
	int32	old_x, old_y;
	int32 test_row, test_column;
	CCB   *test_hazard;
...
*****************************************************************************************/
bool seeker::TrapsLieAhead(dude *target)
{
	int32	old_x, old_y;
	int32 test_row, test_column;
...
to repeat it here.)
*****************************************************************************************/
bool seeker::HandleNormalMove(dude *target,int32 old_x, int32 old_y)
{
...
repeat it here.)
*****************************************************************************************/
bool seeker::HandlePrimeDetourMove(dude *target,int32 old_x, int32 old_y)
{
	int32 alternate_axis;
	bool 	danger;
	int32 old_row, old_column;
...
repeat it here.)
*****************************************************************************************/
bool seeker::HandleAltDetourMove(dude *target,int32 old_x, int32 old_y)
{
	int32 alternate_axis;
	int32 old_row, old_column;
...
repeat it here.)
*****************************************************************************************/
bool seeker::HandleHoudiniMove(dude *target,int32 old_x, int32 old_y)
{
	int32 alternate_axis;
...
*****************************************************************************************/
bool seeker::BrainyMovement (dude *target)
{
	int32	old_x, old_y;
	int32 old_row, old_column;
	bool  move_result;
...
void seeker::HeadForTheDudemeyer (CCB *target,int32 horz_speed,int32 vert_speed)
{
	int32 center_x, center_y;
...
void seeker::FollowHeading (CCB *target, int32 axis, int32 direction,
...
void seeker::CommenceHazardDeath(dude *target)
{
...
bool  seeker::PullIntoHazard (dude *target)
{
	int32 x,y;
...
void seeker::MaintainChameleon (dude *target)
{
...
void seeker::ReviveZombie (dude *target)
{
	int32 i;
	CCB   *tile;
...
void seeker::DealWithSwamp(dude *target)
{
...
void seeker::ShootZombie(solid_object *target)
{
	dude   *zombie;
...
void seeker::ShootSplitter(solid_object *target)
{
	dude   *mom;
...
solid_object* seeker::CheckForSeekerCollisions (solid_object *target)
{
	int32    target_center_x,target_center_y;
	dude		*traversal_ptr;
